...
export const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { key: 'suppliers', label: 'Proveedores', icon: Truck, path: '/suppliers', minLevel: 60 },
      { key: 'purchaseOrders', label: 'Pedidos', icon: ShoppingCart, path: '/purchase-orders', minLevel: 60 },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'taxes', label: 'Impuestos', icon: Receipt, path: '/taxes', minLevel: 60, requiredFeature: 'products' },
  ...
  },
  {
    ...
    items: [
      { key: 'users', label: 'Usuarios', icon: Users, path: '/users', minLevel: 60 },
      { key: 'companies', label: 'Empresas', icon: Building2, path: '/companies', minLevel: 100 },
      { key: 'roles', label: 'Roles', icon: ShieldCheck, path: '/roles', minLevel: 100 },
      { key: 'adminOrganizations', label: 'Organizaciones', icon: Building2, path: '/admin/organizations', minLevel: 100 },
      { key: 'adminUsers', label: 'Usuarios Admin', icon: Users, path: '/admin/users', minLevel: 100 },
      { key: 'adminPlans', label: 'Planes', icon: CreditCard, path: '/admin/plans', minLevel: 100 },
      { key: 'adminInvites', label: 'Invitaciones', icon: Mail, path: '/admin/invites', minLevel: 100 },
      { key: 'adminApprovals', label: 'Pendientes', icon: AlertCircle, path: '/admin/approvals', minLevel: 100 },
      { key: 'adminSubscriptionPayments', label: 'Suscripciones', icon: CreditCard, path: '/admin/subscription-payments', minLevel: 100 },
    ],
  },
  {
    key: 'config',
