...
export const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'adminOrganizations', label: 'nav.adminOrganizations', icon: Building2, path: '/admin/organizations', minLevel: 100 },
      { key: 'adminUsers', label: 'nav.adminUsers', icon: Users, path: '/admin/users', minLevel: 100 },
      { key: 'adminPlans', label: 'nav.adminPlans', icon: CreditCard, path: '/admin/plans', minLevel: 100 },
      { key: 'adminInvites', label: 'nav.adminInvites', icon: Mail, path: '/admin/invites', minLevel: 100 },
      { key: 'adminApprovals', label: 'nav.adminApprovals', icon: AlertCircle, path: '/admin/approvals', minLevel: 100 },
      { key: 'adminSubscriptionPayments', label: 'nav.adminSubscriptionPayments', icon: CreditCard, path: '/admin/subscription-payments', minLevel: 100 },
    ],
  },
  {
    key: 'config',
